...
let myDatabase = {
  ...
  authorsImg: {
    ...
    JSON.stringify({
        ...
        "image": "assets\\img\\husflid\\skapbokser\\E4A97ED327FA40229ADA78E2F929F04B.jpg",
        "alt": "",
        "innholdsTekst": "Lite eksempel på hverdag kreativetet. Bokser laget med materialene vi har hjemme!",
        "flavourText": "A small example of everyday creativity. The boxes where made with the material we had available at home",
    }),
    JSON.stringify({
        "navn": "Vaser med gjennbrukte materialer",
        "name": "Vases made with reusable materials",
        "image": "assets\\img\\husflid\\vases\\EFC21D99216C4D90898FECE5E2D190D1.jpg",
        "alt": "",
        "innholdsTekst": "",
        "flavourText": "",
    })],
    ...
    utfoldelse: [
        ...
        JSON.stringify({
            ...
            "alt": "",
            "innholdsTekst": "Fra bloggposten 'eksperimentering med kombisjoner av farger'",
            "flavourText": "From the blog post 'experiments with combinations of colors'",
        }),
        JSON.stringify({
        ...
        { 
            case "tegneserie":
                element.indices.forEach(index => {
                    returnObject.object.push (JSON.parse(this.samling.tegneserie[index]))
                });
                break;
            case "utfoldelse":
                element.indices.forEach(index => {
                    returnObject.object.push (JSON.parse(this.samling.utfoldelse[index]))
                });
                break;
            case "husflid":
                element.indices.forEach(index => {
            ...
            default:
                console.log(element.type,"element.type is not a valid input to getSamlingObject");
        }
